...
import { html } from '../helpers/preguntas';
...
export default class Html extends Component {
    ...
    componentDidMount() {
        const currentQuizData = html[this.state.numberQuestion]
    ...
    handleSubmit = (e) => {
        ...
        if (this.state.numberQuestion < html.length) {
            ...
            <DivForm>
                <FormStyle onSubmit={this.handleSubmit}>
                    ...
                    <div className='w-75 mt-5 d-inline-block'>
                        <ProgressBar variant="success" min={0} max={12} now={this.state.numberQuestion} />
                    </div>
